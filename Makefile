...
PRODUCT_NAME       = cs1372
SOURCES            = main.c myLib.c tiles.c letters.c s1.c bgMusic.c arrowSound.c raptorDeath.c splash.c airDinoDeath.c s2.c pirateDeath.c bgMusic2.c gunshot.c tiles2.c s3.c tiles3.c explode.c clink.c bossMusic.c menuMusic.c victory.c
